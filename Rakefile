...
task :server do
  sh "env DATABASE_URL=postgres://ledger:password@kodos.zrail.net/ledger LEDGER_USERNAME=admin LEDGER_PASSWORD=foo LEDGER_PAYDAY_BENCHMARK=2013-01-18 EMERGENCY_FUND_TARGET=4 rackup -p 9595"
end
